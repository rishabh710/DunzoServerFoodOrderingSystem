package com.example.dunzoserver.Service;
...
import com.example.dunzoserver.Helper.NotificationHelper;
import com.example.dunzoserver.MainActivity;
import com.example.dunzoserver.Model.Token;
import com.example.dunzoserver.OrderStatus;
...
public class MyFirebaseMessaging extends FirebaseMessagingService {
    ...
    private void updateToServer(String refreshedToken) {
        if (Common.currentUser!=null) {
            ...
            Token data = new Token(refreshedToken, true); //true for server side
